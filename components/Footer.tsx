      ...
      >
        ...
        <div className="space-y-5 sm:col-span-2 md:col-span-1">
          ...
          <p className="max-w-xs text-[14px] leading-[1.7] text-[#4e4448]">
            Erode, we provide quality skin treatments at affordable prices without compromising on care and safety.
          </p>
          {/* Social */}
        ...
        {/* Contact – Erode Branch */}
        <div className="space-y-4">
          <h4 className="text-xs font-semibold uppercase tracking-[0.2em] text-[#492e3b]">Erode Branch</h4>
          <div className="space-y-4">
